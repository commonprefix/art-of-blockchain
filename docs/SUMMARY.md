...
* [The Art of Blockchain Programming](index.md)
...
* [Git / Github](prerequisites/git-knowledge.md)
* [Relational / Non-relational DBs](prerequisites/database-knowledge.md)
* [Queues](prerequisites/queues.md)
* [Basic Servers Knowledge](prerequisites/basic-servers-knowledge.md)
* [Basic Networks](prerequisites/basic-networks.md)

## Foundations

* [Blockchain Basics](foundations/blockchain-basics.md)
...
* [Bitcoin](specialization/bitcoin.md)
* [Ethereum](specialization/ethereum.md)
* [Axelar](specialization/axelar.md)
